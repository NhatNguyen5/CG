...
int main()
{
    ...
    GLuint texture = loadDDS("companionCube.dds");
    ...
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(GLfloat), (GLvoid*)(0 * sizeof(GLfloat)));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, currentFrame, { 1,0,1 });
